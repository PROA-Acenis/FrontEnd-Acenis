...
import Carrinho from '../src/pages/carrinho/carrinho' /* Está quebrado | tela branca */
...
import HomeLoja from '../src/pages/homeloja/homeloja' /* Está quebrado | tela branca */
...
import Produtos from '../src/pages/produto/produto' /* Está quebrado | tela branca */
